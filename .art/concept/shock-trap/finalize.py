#!/usr/bin/env python3
"""Finalize a ShockTrap candidate that already carries real alpha.

Never mattes a painted background away. Only works on a source that already
has a true alpha channel from the generator. If the source is opaque or
carries a painted checkerboard/solid background, this script refuses.
"""
...
def main() -> None:
    ...
    if image.getchannel("A").getextrema() == (255, 255):
        sys.exit(
            ...
            "the transparent-background option instead."
        )
