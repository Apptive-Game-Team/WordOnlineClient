#!/usr/bin/env python3
"""Finalize a wall_golem candidate that already carries real alpha.

This never mattes a painted background away. It only works on a source that
already has a true alpha channel from the generator. If the source is opaque
or carries a painted checkerboard, this script refuses and says so —
regenerate instead.
"""
