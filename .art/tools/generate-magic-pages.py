...
KOREAN_NAMES = {
    ...
    "fire_spirit": "불의 정령",
    "firework_tower": "폭죽 타워",
    "frenzy_totem": "광란의 토템",
    "grass_generator": "풀 생성기",
    "healing_totem": "회복 토템",
    "leafair": "술이파리",
    "life_tree": "생명의 나무",
...
DISPLAY_NAMES = {
    ...
    "firework_tower": "폭죽 포탑",
    "frenzy_totem": "군단 광란토템",
    "grass_generator": "풀 배양기",
    ...
    "tidal_warhead": "심해 유도탄",
    "tide_call": "밀려드는 해일",
    "titan_remnant": "무너진 거인의 주먹",
