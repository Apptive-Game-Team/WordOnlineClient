...
물 슬라임의 독립 개체로 전장에 합류하는 물결 궁수.

## 컨셉 설명

물결 궁수은 물 슬라임의 소환 마법이다. 이동 AI가 지면 경로와 `RigidBody` 속도를 사용한다. 전투에서는 원거리 공격 역할을 맡으며, 지상·공중 대상을 단일 표적 방식으로 다룬다. 추가 특수 이동은 없다. 시각적으로는 물질적인 반투명 종이층과 둥근 체적. 세계수 정령과 구분한다.
...
- Magic: `game/src/main/java/com/wordonline/server/game/domain/magic/implement/spawn/AquaArcherMagic.java`
- Prefab initializer: `game/src/main/java/com/wordonline/server/game/domain/object/prefab/implement/misc/AquaArcherPrefabInitializer.java`
