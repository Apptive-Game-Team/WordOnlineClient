...
namespace Script.Data
{
    ...
    public static class LocalCombinedMagicData
    {
        public static List<CombinedMagicData> dataList = new()
        {
            ...
            new (){magicName = "Nature Slime Swarm", recipe = new () { CardType.Spawn , CardType.Nature}, spritePath = "Game/spawn/nature_slime"},
            ...
            new (){magicName = "Nature Shot", recipe = new () { CardType.Shoot , CardType.Nature}, spritePath = "Game/shoot/nature_shoot"},
            ...
            new (){magicName = "Nature Slime Nest", recipe = new () { CardType.Build , CardType.Nature}, spritePath = "Game/build/nature_slime_nest"},
            ...
            new (){magicName = "Nature Explosion", recipe = new () { CardType.Build , CardType.Nature}, spritePath = "Game/explode/nature_explode"},
